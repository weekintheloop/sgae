...
function createRecord(sheetName, data) {
  try {
    ...
    var sheet = (typeof getSS === "function" ? getSS() : SpreadsheetApp.getActiveSpreadsheet()).getSheetByName(sheetName);
    if (!sheet) {
...
function logOperation(operation, sheetName, details) {
  ...
  try {
    ...
    var sheet = (typeof getSS === "function" ? getSS() : SpreadsheetApp.getActiveSpreadsheet()).getSheetByName('System_Logs');
    if (sheet) {
